...
4.  Espere a que se complete el Deployment. La implementación tardará
    unos 10-15 minutos.

5.  Una vez completado el Deployment, haga clic en el botón **Go to
    resource**.
     ![](./media/image20.png)
...
f.  Formato de datos: **JSON** y pulse el botón **Next**
      ...
      ![](./media/image34.png)
      ![](./media/image35.png)
6.  Verá una notificación indicando **Successfully added The source
    “StockEventHub,Azure Event Hubs”**.
      ![](./media/image36.png)
7.  Con el Event Hub configurado, haga clic en **Test result**.
